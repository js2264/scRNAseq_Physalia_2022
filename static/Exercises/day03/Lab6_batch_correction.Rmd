...
# Only run this once, as they are not installed in our AMI environment.
# BiocManager::install('multtest')
# packageurl <- "https://cran.r-project.org/src/contrib/Archive/metap/metap_1.4.tar.gz"
...
# Additional exploration: Seurat v4
