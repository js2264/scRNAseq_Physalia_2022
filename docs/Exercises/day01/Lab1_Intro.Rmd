...
Simply open a browser and copy-paste [the following address](http://35.89.123.49:8787): 

```{sh eval = FALSE}
http://35.89.123.49:8787
```
...
## 2. Use a AWS terminal within RStudio
...
wget -i GSE148963_fastqlist.txt
